      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-neutral-400">
            ...
            <span>Menzel Jemil, Bizerte.</span>
          </div>
        ...
        <div>
          {!isSubmitSuccessful && (
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input type="hidden" value="HachemCv" {...register("from_name")} />
              <input
                type="checkbox"
                id=""
                className="hidden"
          ...
          {isSubmitSuccessful && isSuccess && (
            <>
              <div className="flex flex-col items-center justify-center text-center text-white rounded-md">
                ...
                <button
                  className="mt-6 py-2 px-4 bg-white-500 rounded-full focus:outline-none text-neutral-100"
                  onClick={() => reset()}
                >
                  Go back
                </button>
